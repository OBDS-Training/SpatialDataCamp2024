...
```{r}
ImageFeaturePlot(seurat_CRC1, "CD24", size=.5) + scale_fill_viridis_c()
ImageFeaturePlot(seurat_CRC1, "ANXA1", size=.5) + scale_fill_viridis_c()
ImageFeaturePlot(seurat_CRC1, "MS4A1", size=.5) + scale_fill_viridis_c()
...
```{r}
DimPlot(seurat_CRC1, group.by = "predicted.id")
...
# pull out the proportion of eahc cell type from the object 
...
FeatureScatter(seurat_CRC1, "MS4A1", "CD3D", jitter=T)
FeaturePlot(seurat_CRC1, c("MS4A1", "CD3D"))
FeaturePlot(seurat_CRC1, c("MS4A1", "CD24"))
FeaturePlot(seurat_CRC1, c("CD24", "ANXA1"))
